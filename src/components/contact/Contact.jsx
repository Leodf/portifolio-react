...
const Contact = () => {
    const [state, handleSubmit] = useForm("mrgdrpbl");
    if (state.succeeded) {
        return (
            <div className="contact-container-message">
                <div className="contact-card">
                    <h3 class="contact-title">Obrigado pelo seu envio!!!</h3>
                </div>
            </div>
        )
    }
  return (
    <section className="contact section" id="contact">
        ...
        <span className="section-subtitle">me fale sobre seu projeto</span>
        ...
        <div className="contact-container container grid">
            ...
            <div className="contact-content">
                <h3 className="contact-title">Escreva-me seu projeto!</h3>

                <form onSubmit={handleSubmit} className="contact-form">
                    <div className="contact-form-div">
                        <label className="contact-form-tag">Nome</label>
                        <input id="nome" type="text" name="nome" className='contact-form-input'
                    ...
                    <div className="contact-form-div">
                        ...
                        <input id="email" type="email" name="email" className='contact-form-input'
